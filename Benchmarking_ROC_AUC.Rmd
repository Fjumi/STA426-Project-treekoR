...
```{r}
all<-list(breast_hpch,breast_link,breast_prnt,cmv_hpch,cmv_link,cmv_prnt,blood_hpch,blood_link,blood_prnt,baron_hpch,baron_link,baron_prnt,math_hpch,math_link,math_prnt,covid4_hpch,covid4_link,covid4_prnt,covid8_hpch,covid8_link,covid8_prnt,mela_hpch,mela_link,mela_prnt)
title<-rep(c("%total hopach","%total average linkage","%parent"),8)

par(mfrow=c(2,3))

for(i in 1:length(all)){
  plot(all[[i]][[2]],colorize=T,main=title[i])
}
```
